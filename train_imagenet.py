...
from model1 import NetworkImageNet as Network
...
parser.add_argument('--save', type=str, default='/public/home/wangwenna/checkpoints/', help='experiment name')
...
parser.add_argument('--tmp_data_dir', type=str, default='/public/home/wangwenna', help='temp data dir')
...
#    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, args.decay_period, gamma=args.gamma)
    ...
    start_epoch=-1
    if RESUME:
        path_checkpoint = "/home/D/wwn/checkpoints/ckpt_best_1.pth"  # 断点路径
    ...
    for epoch in range(start_epoch+1,args.epochs):
        ...
        if not os.path.isdir("/home/D/wwn/checkpoints/"):
            os.mkdir("/home/D/wwn/checkpoints/")
        torch.save(checkpoint, '/home/D/wwn/checkpoints/ckpt_best_%s.pth' % (str(epoch)))
