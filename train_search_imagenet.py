...
parser.add_argument('--save', type=str, default='/home/ggg/PCvvv/checkpoints/', help='experiment name')
...
parser.add_argument('--tmp_data_dir', type=str, default='/home/ggg/', help='temp data dir')
